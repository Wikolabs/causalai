...
export const metadata: Metadata = { title:"CausalAI — Agent IA d'inference causale et analyse racine", description:"Depassez la correlation. CausalAI identifie les vraies causes de vos problemes metier et vous indique les leviers d'action prioritaires avec l'analyse causale par IA." };
